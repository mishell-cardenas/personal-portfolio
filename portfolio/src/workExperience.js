...
const ExperiencePage = () => {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "Supported day-to-day operations and helped automate processes, including SAP-based demand planning for procurement.",
      bullets: [
    ...
    },
    {
      ...
      subtitle: "Amundi",
      description:
        "Managed financial data validation, coordinated content updates, and launched an ESG training initiative.",
      bullets: [
